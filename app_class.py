...
class App:
    ...
    def start__draw(self):
        ...
        self.draw_text('PUSH SPACEBAR', self.screen, [WIDTH//2, HEIGHT//2 - 25], START_TEXT_SIZE, (170, 132, 58), START_FONT, centered=True)
        self.draw_text('1 PLAYER ONLY', self.screen, [WIDTH//2, HEIGHT//2 + 25], START_TEXT_SIZE, (44, 167, 198), START_FONT, centered=True)
